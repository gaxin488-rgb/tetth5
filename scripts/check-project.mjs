...
const required = ['public/index.html','public/styles.css','public/app.js','public/data/movies.json','worker/index.js','scripts/auto-sub.mjs','scripts/auto-sub-local.py','scripts/setup-free-subtitles.ps1','requirements-free.txt','migrations/0002_auto_subtitles.sql','wrangler.jsonc','schema.sql','seed.sql'];
let failed=false;
